    ...
    return (
        ...
        >
            ...
            <div className="p-4 flex flex-col flex-1">
                ...
                {/* Bloc haut — flex-1 pour pousser le bas vers le bas */}
              ...
              <span className="text-[9px] font-semibold text-gray-400 uppercase tracking-wider">
                    ...
                    {equipements.length > 0 && (
                        <div className="flex flex-wrap gap-1">
                            {equipements.map((eq) => (
                                <span
                                    key={eq}
                                    className="text-[10px] text-[#0369A1] bg-[#E0F2FE] px-2 py-0.5 rounded-full"
                                >
                  {eq}
                </span>
                            ))}
                    ...
                    {/* Description — 1 ligne max, jamais plus */}
                    {hotel.description && (
                ...
                {/* Bloc bas — toujours collé en bas */}
